  ...
  describe('renders', () => {
    describe('suggestion list', () => {
      ...
      test('with correct suggestions', () => {
        ...
        expect(actual.at(0).find('h4').text()).toEqual('suggestion name')

        expect(actual.at(0).find('h5').text()).toEqual('suggestion email')
      })
    })
